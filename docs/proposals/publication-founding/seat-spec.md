# The <OFFICE>: law of the security-publication seat

Status: DRAFT, drawn by the Regent under edict 2026-08-04. Gate 1 applies —
this is proposed, not applied. The office title is filled in from the Second
Naming Moot; the occupant's own name, pronouns and charge are theirs to declare
and appear only in the seat file.
